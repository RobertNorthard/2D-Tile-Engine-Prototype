...
Public Class Sprite
    ...
    ''' <summary>
    ''' Stores the current sprite state' the direction the sprite is facing
    ''' </summary>
    ...
    ''' <summary>
    ''' Calculates the current sprites positoning on tile. And allows one invoke changes the tile under the sprite to a 
    ''' </summary>
